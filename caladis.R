...
plot(h2,col=rgb(1,0,0,0.2), xlim= c(0,8), freq=F, main="Y1", xlab = "log(NPP / g m-2 yr-1)", ylab="Caladis prob")
...
plot(h3,col=rgb(0,0,1,0.2), xlim=c(0,8),freq=F, main="Y2",xlab = "log(NPP / g m-2 yr-1)", ylab="Caladis prob") 
